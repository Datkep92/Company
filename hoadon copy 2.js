...
function createPayableFilterUI() {
    ...
    // TÌM ĐÚNG CARD CÔNG NỢ PHẢI TRẢ NCC
    const payableCards = document.querySelectorAll('#mua-hang .content-body .card');
    let payableSection = null;
    
    for (let card of payableCards) {
        const header = card.querySelector('.card-header');
            ...
            <div class="card-body">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
                        ...
                        <input type="text" id="search-payable" placeholder="Tên NCC, MST..." class="form-control">
                    </div>
                    <div class="form-group">
